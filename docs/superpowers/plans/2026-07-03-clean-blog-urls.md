...
curl -T /Users/naveen/Documents/Github/personal/Website/blog.html \
  -u u738123768.mosaichostels:"[REDACTED-FTP-PASSWORD]hostels" \
...
1. Revert blog.html to use query string URLs:
   ...
   curl -T blog.html -u u738123768.mosaichostels:"[REDACTED-FTP-PASSWORD]hostels" ftp://mosaichostels.com/blog.html
   ```

2. Or restore from backup:
   ```bash
   curl -T /backup/blog.html -u u738123768.mosaichostels:"[REDACTED-FTP-PASSWORD]hostels" ftp://mosaichostels.com/blog.html
   ```
