...
- FTP credentials: `u738123768.mosaichostels` / `[REDACTED-FTP-PASSWORD]hostels`
...
```bash
curl -u u738123768.mosaichostels:[REDACTED-FTP-PASSWORD]hostels \
...
git config git-ftp.password "[REDACTED-FTP-PASSWORD]hostels"
...
- git-ftp.password = [REDACTED-FTP-PASSWORD]hostels
